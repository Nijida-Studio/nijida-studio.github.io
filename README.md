...
repository's `main` branch and this site will switch its theme reference to
`Nijida-Studio/nijida-theme@main`.

The permanent theme preview at `themetest.nijida.de` remains on
`nijida-theme/gh_pages` and continues to use the `themetest` branch.
